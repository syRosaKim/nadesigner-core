...
public class N3MLAlgorithmDialog extends javax.swing.JDialog {
    ...
    private void generateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_generateButtonActionPerformed
        ...
        if((hN3mlAlgorithm==H_N3ML_A_softLIF) && (!dataDirTextField.getText().equals("This is your pretrained data directory."))){
            ...
            showInputNumberLayerDialog(hN3mlIOConf, hN3mlAlgorithm);
        }
    ...
    private void dataDirBrowseButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dataDirBrowseButton1ActionPerformed
        evt.setSource(dataDirBrowseButton1);
        selectDirectory(evt);
    ...
    private void showInputNumberLayerDialog(HN3MLIOConfig hN3mlIOConf, int type){
        InputNumberLayerDialog dialog = new InputNumberLayerDialog(null, true, hN3mlIOConf, H_N3ML, hDirectory, type);        
    ...
    private void loadLib() {
        ...
        if(hN3mlAlgorithm==H_N3ML_A_STDP){
            libDir = new File(dataDirTextField1.getText());
...
//    }
    ...
    public void selectDirectory(java.awt.event.ActionEvent evt) {
        ...
        if (evt.getSource() == dataDirBrowseButton) {
            ...
            dataDirTextField.setText(FileUtil.normalizeFile(fileDir).getAbsolutePath());
        }
        }
        else if(evt.getSource()==dataDirBrowseButton1){
            FileUtil.preventFileChooserSymlinkTraversal(fileChooser, null);
            fileChooser.setDialogTitle(title);
            fileChooser.setFileSelectionMode(JFileChooser.DIRECTORIES_ONLY);
            path = dataDirTextField1.getText();
            ...
            if (JFileChooser.APPROVE_OPTION == fileChooser.showOpenDialog(this)) {
                ...
                dataDirTextField1.setText(FileUtil.normalizeFile(projectDir).getAbsolutePath());
